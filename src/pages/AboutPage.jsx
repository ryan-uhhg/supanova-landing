...
const timeline = [
  ...
  },
  {
    ...
    label: '구축',
    title: '직접 만들기로 했습니다',
    body: '보안망 안에서 작동하고, 문서를 누적으로 기억하며, 컨설팅 수준의 논리 구조를 갖춘 보고서를 자동으로 출력하는 시스템. 그런 도구가 세상에 없었기에 직접 만들었습니다. 8개월간의 주말과 새벽을 투자해 완성한 것이 Supanova입니다.',
    color: 'gold',
  },
  {
    year: '2026',
    ...
    body: '동료 기획자들에게 보여줬을 때 반응은 동일했습니다. "이거 어디서 살 수 있어?" 같은 고통을 겪고 있는 기획자들에게 이 도구를 전달하기 위해 Supanova를 제품으로 만들기로 결심했습니다.',
    color: 'accent',
  },
];
...
const stats = [
  ...
  { value: '0건', label: 'Supanova 서버 전송 데이터' },
];
            ...
            <div className="card-bezel-inner text-center py-14 md:py-16 relative">
              ...
              <div className="relative z-10">
                ...
                <p className="text-silver text-[14px] leading-[1.85] max-w-xl mx-auto text-center">
                  Supanova는 기획자의 인지 에너지를 보호하는 것을 사명으로 합니다. 정보를 수집하고 정리하는 반복 노동에서 기획자를 해방시켜, 진정으로 가치 있는 판단과 결정에 집중할 수 있는 환경을 만듭니다.
                </p>
                <div className="mt-8 pt-8 border-t border-white/[0.05]">
                  <div className="text-ash text-[13px]">
                    <span className="text-ivory font-semibold">Supanova 파운더</span>
