...
const faqPurchase = [
  ...
  { q: '법인 라이선스가 있습니까?', a: '5라이선스 이상 구매 시 법인 할인을 제공합니다. support@createnova.co로 문의하여 주십시오.' },
...
const faqSecurity = [
  ...
  { q: '사내 보안 감사를 통과할 수 있습니까?', a: '원본 파일이 외부 전송되지 않으므로 DLP 정책 관점에서 유리합니다. 보안 검토용 기술 문서는 support@createnova.co로 요청하실 수 있습니다.' },
];

const faqSupport = [
  { q: '기술 지원은 어떻게 받습니까?', a: 'Premium 구매자는 전용 지원 채널(이메일 우선 응답)을 이용하실 수 있습니다. Basic 구매자는 일반 이메일 지원을 제공합니다.' },
  { q: '앱이 작동하지 않으면 어떻게 합니까?', a: 'support@createnova.co로 문의하시면 24시간 이내에 기술 지원을 제공합니다. 해결 불가 시 100% 환불 보증이 적용됩니다.' },
];
  ...
  return (
    <div>
      <PageHero
        eyebrow="FAQ"
        headline={'자주 묻는 질문'}
        subCopy="궁금한 점이 해결되지 않으면 support@createnova.co로 문의하여 주십시오."
      />
      ...
      <section className="w-full py-10">
        <div className="section-container max-w-3xl text-center">
          ...
          <a
            href="mailto:support@createnova.co"
